...
function scene:create( event )
    ...
    --terrains
    --print(_CX .. _CY)
    terrain[1] = terrains.new(world,5,decor, 600 , 0, _CY)
    terrain[2] = terrains.new(world,5,decor, 600 , 0, _CY + 300)
    terrain[3] = terrains.new(world,5,decor, 600 , terrain[1].x_end, _CY+400)
    terrain[4] = terrains.new(world,5,decor, 1200 , terrain[3].x_end, _CY+300)
    
    blockade = display.newRect(world, terrain[4].x_end + 120, _CY-150, 300, 1000)
    ...
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 1500, _CY , 100, 100)
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 1650, _CY , 100, 100)
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
