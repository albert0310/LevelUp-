...
function scene:create( event )
    ...
    local txtStory = display.newText(BG, "After Bandung Bondowoso leave you to reach the village" , 400, 120, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    txtStory = display.newText(BG, "You start to chase after him" , 400, 140, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    txtStory = display.newText(BG, "But the way isn't an easy road" , 400, 160, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    txtStory = display.newText(BG, "He put his minnions to stall you from chasing him" , 400, 180, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    ...
    txtContinue:addEventListener("tap", gotoStage2)
