...
local world, hero,skill, musuh, wall, BG, blockade, decor, healthbar
local enemies = {}
...
function scene:create( event )
    ...
    --terrains
    --print(_CX .. _CY)
    terrain[1] = terrains.new(world,2,decor, 800 , 0, _CY)
    terrain[2] = terrains.new(world,2,decor, 1000, terrain[1].x_end, _CY-120)
    terrain[3] = terrains.new(world,2,decor, 1200, terrain[2].x_end, _CY-250)
    terrain[4] = terrains.new(world,2,decor, 700,terrain[3].x_end, _CY-100)
    terrain[5] = terrains.new(world,2,decor, 900,terrain[4].x_end, _CY-200)
    
    blockade = display.newRect(world, terrain[5].x_end + 120, _CY-150, 300, 1000)
    ...
    musuh = display.newRect(world, 700, _CY-20 , 100, 100)
    musuh = enemy.new(musuh, "pocong", hero)
    table.insert(enemies, musuh)
    ...
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 2400, _CY-270 , 100, 100)
    musuh = enemy.new(musuh, "pocong", hero)
    table.insert(enemies, musuh)
    ...
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 3350, _CY-160 , 100, 100)
    musuh = enemy.new(musuh, "pocong", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 3400, _CY-160 , 100, 100)
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 3800, _CY-200 , 100, 100)
    musuh = enemy.new(musuh, "buto", hero)
    musuh.hp = musuh.hp*1.5
    musuh.xScale = 1.5
    musuh.yScale = 1.5
    table.insert(enemies, musuh)
