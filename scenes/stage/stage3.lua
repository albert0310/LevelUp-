...
function scene:create( event )
    ...
    terrain[3] = terrains.new(world,2,decor, 700, terrain[2].x_end, _CY-150)
    terrain[4] = terrains.new(world,2,decor, 400,terrain[3].x_end, _CY-400)
    ...
    blockade.x, blockade.y = terrain[6].x_end + 120, _CY-150
    blockade.xScale = -1
    ...
    musuh = enemy.new(musuh, "buto", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 3400, _CY-200 , 100, 100)
    musuh = enemy.new(musuh, "kuyang", hero)
    table.insert(enemies, musuh)
    musuh = display.newRect(world, 3500, _CY-200 , 100, 100)
...
local function enterFrame(event)
    ...
    if (hero.x < 3200 or hero.y >= _CY - 200) then
