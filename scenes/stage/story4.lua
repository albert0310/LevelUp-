...
function scene:create( event )
    ...
    local txtStory = display.newText(BG, "When he reach the village, " , 400, 120, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    local txtStory = display.newText(BG, "Bandung Bondowoso already wrecked the whole place" , 400, 140, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    txtStory = display.newText(BG, "Many of his minnions already there to wrecked the village" , 400, 160, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    txtStory = display.newText(BG, "You try to fend off some of them before any more casualties" , 400, 180, "assets/fonts/Shadow of the Deads.ttf", 11)
    txtStory.fill = {color.hex2rgb("#dba400")}
    ...
    txtContinue:addEventListener("tap", gotoStage4)
